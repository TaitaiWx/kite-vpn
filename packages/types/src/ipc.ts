...
// ---------------------------------------------------------------------------
// Commands — messages sent from the UI to the backend
// ---------------------------------------------------------------------------
...
export interface IpcCommands {
  ...
  'engine:start': { configPath?: string }
  ...
  'subscription:add': { name: string; url: string }
  /** Remove a subscription by id. */
  'subscription:remove': { id: string }
  ...
  'subscription:toggle': { id: string; enabled: boolean }
  ...
  'config:set-mode': { mode: ProxyMode }
  ...
  'proxy:test-delay': { name: string; url?: string; timeout?: number }
  /** Test delay for all proxy nodes. */
  'proxy:test-all-delay': { url?: string; timeout?: number }
}

// ---------------------------------------------------------------------------
// Events — messages pushed from the backend to the UI
// ---------------------------------------------------------------------------
