...
export type ProxyProtocol = 'shadowsocks' | 'vmess' | 'vless' | 'trojan' | 'hysteria2' | 'tuic' | 'wireguard' | 'shadowsocksr';
 ...
 */
export type ProxySettings = ShadowsocksSettings | VMessSettings | VLessSettings | TrojanSettings | Hysteria2Settings | TuicSettings | WireGuardSettings | ShadowsocksRSettings;
/**
