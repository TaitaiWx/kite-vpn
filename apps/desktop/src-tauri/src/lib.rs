...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Mesh (Phase 4 — framework only, sidecar 待集成)
            commands::mesh_get_engine_state,
            commands::mesh_start,
            commands::mesh_stop,
            commands::mesh_list_peers,
            commands::mesh_get_network,
            commands::mesh_create_network,
            ...
            commands::account_request_login,
            commands::account_remember_email,
            commands::account_verify_login,
            commands::account_logout,
            commands::account_backup_ca_key,
            commands::account_restore_ca_key,
            // Account v0.2: F 邀请 / G bridge / update sig
            commands::account_create_invite,
            commands::account_list_invites,
            commands::account_revoke_invite,
            commands::account_consume_invite,
            commands::account_create_bridge_invite,
            commands::account_redeem_bridge,
            commands::account_list_bridges,
            commands::account_revoke_bridge,
            commands::account_fetch_update_pubkey,
            commands::account_check_update_signed,
